from scenic_reasoning.data.ImageLoader import Bdd10kDataset, Bdd100kDataset, WaymoDataset_seg
...
measurements = InstanceSegmentationMeasurements(model, waymo, batch_size=BATCH_SIZE, collate_fn=lambda x: x) # hacky way to avoid RuntimeError: each element in list of batch should be of equal size
